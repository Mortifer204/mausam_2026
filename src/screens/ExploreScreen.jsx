...
export function ExploreScreen() {
  ...
  return (
    <div className="w-full max-w-md mx-auto px-4 pb-24 pt-2 space-y-4">
        ...
        {[
          ...
          return (
            <button
              ...
              className={`flex items-center gap-1.5 px-3.5 py-2 rounded-full text-xs font-semibold whitespace-nowrap border transition ${
                isActive 
      ...
      <div className="relative rounded-3xl mausam-card border border-white/[0.08] overflow-hidden aspect-[4/3] flex flex-col justify-between p-4 bg-[#081120]">
        {/* Radar concentric range circles */}
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-30">
          <div className="w-64 h-64 rounded-full border border-cyan-400/40 flex items-center justify-center">
            <div className="w-44 h-44 rounded-full border border-cyan-400/50 flex items-center justify-center">
              <div className="w-24 h-24 rounded-full border border-cyan-400/60 flex items-center justify-center">
                <div className="w-3 h-3 rounded-full bg-cyan-400 shadow-[0_0_12px_rgba(6,182,212,1)]" />
              </div>
            </div>
          </div>
        </div>
        ...
        {activeLayer === 'radar' && (
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <div className="w-32 h-24 rounded-full bg-gradient-to-tr from-cyan-500/30 via-emerald-500/30 to-teal-500/40 blur-xl translate-x-8 -translate-y-6 animate-pulse-slow" />
          </div>
        )}
        ...
        {activeLayer === 'aqi' && (
          <div className="absolute inset-0 bg-gradient-to-r from-emerald-500/20 via-cyan-500/20 to-indigo-500/20 blur-2xl pointer-events-none" />
        )}

        {/* Top Controls Overlay */}
        <div className="relative z-10 flex items-center justify-between">
          <div className="px-3 py-1 rounded-full bg-[#111A2E]/80 backdrop-blur-md border border-white/[0.08] text-[10px] font-bold text-white flex items-center gap-1.5">
          ...
          <button
            ...
            className="p-1.5 rounded-full bg-[#111A2E]/80 backdrop-blur-md border border-white/[0.08] text-white hover:bg-white/20 transition"
        ...
        <div className="relative z-10 p-2.5 rounded-2xl bg-[#111A2E]/80 backdrop-blur-md border border-white/[0.08] flex items-center justify-between text-[10px]">
          <div>
          ...
          <div className="text-right">
            ...
            <span className="text-cyan-300 font-bold">15 min scan cycle</span>
          </div>
        </div>
      </div>
      ...
      <div className="mausam-card rounded-3xl p-5 border border-white/[0.08] space-y-3">
        ...
        <div className="grid grid-cols-2 gap-2 text-xs">
          <div className="p-3 rounded-2xl mausam-subcard border border-white/[0.06] space-y-1">
          ...
          <div className="p-3 rounded-2xl mausam-subcard border border-white/[0.06] space-y-1">
            <div className="flex items-center gap-1.5 text-slate-300 text-[10px] font-bold uppercase">
              <Eye className="w-3.5 h-3.5 text-cyan-400" /> Road Visibility
            </div>
